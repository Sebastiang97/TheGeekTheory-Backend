...
CREATE TABLE "Payment" (
    ...
    CONSTRAINT "Payment_payerId_fkey" FOREIGN KEY ("payerId") REFERENCES "Payer" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_ProductPay" (
    ...
    "payId" TEXT NOT NULL,
    CONSTRAINT "ProductPay_payId_fkey" FOREIGN KEY ("payId") REFERENCES "Payment" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
