...
async function main() {
  // Crear categorías
  const mujeresCategory = await prisma.category.create({
    data: {
      name: 'Mujeres',
    },
  });

  const hombresCategory = await prisma.category.create({
    data: {
      name: 'Hombres',
    },
  });
  ...
  //       create: [
  //         { 
  //           url: 'https://res.cloudinary.com/dk41avvjd/image/upload/v1716168105/dvh8lfmezjmpf1hlrfow.png',
  //         },
  //         { 
  //           url: 'https://res.cloudinary.com/dk41avvjd/image/upload/v1716168105/oaabw0a4imsrelkus7yb.png',
  //         }
  //       ],
  //     },
  //   },
  ...
  //       create: [
  //         { 
  //           url: 'https://res.cloudinary.com/dk41avvjd/image/upload/v1716168105/to1kmxx4pndqlwucotms.png',
  //         },
  //         { 
  //           url: 'https://res.cloudinary.com/dk41avvjd/image/upload/v1716168105/zvksmtt2axndykjbnh7d.png',
  //         }
  //       ],
  //     },
  //   },
